...
-- Date: 2025-10-15
-- Purpose: Fix "cannot change return type of existing function" error by dropping and recreating functions

-- ==============================================================================
-- STEP 1: Drop Existing Functions That May Have Type Conflicts
-- ==============================================================================

-- Drop all functions that may have return type conflicts
...
-- ==============================================================================
-- STEP 2: Recreate User Accessible Accounts Function with Correct Return Type
-- ==============================================================================
...
$$;
-- ==============================================================================
-- STEP 3: Recreate User Accessible Prospects Function
-- ==============================================================================
...
$$;
-- ==============================================================================
-- STEP 4: Recreate User Accessible Contacts Function
-- ==============================================================================
...
$$;
-- ==============================================================================
-- STEP 5: Recreate User Accessible Opportunities Function
-- ==============================================================================
...
$$;
-- ==============================================================================
-- STEP 6: Create Sample Data for FOX Roofing Tenant
-- ==============================================================================
...
$$;
-- ==============================================================================
-- STEP 7: Update RLS Policies for Tenant Data Access
-- ==============================================================================
...
SELECT 'Function return type fix migration completed successfully' as status;
